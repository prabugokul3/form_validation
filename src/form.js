        ...
        <div className='container'>
            <form className='' onSubmit={formik.handleSubmit}>
                ...
                <div className='border border-0 rounded p-5 bg-light'>
                    <div className='mb-2'>
                        <label className='fs-6 fw-bolder text-gray-900'>First Name</label>
                        <input
                    ...
                    <div className='mb-2'>
                        <label className='fs-6 fw-bolder text-gray-900'>Last Name</label>
                        <input
                    ...
                    <div className='mb-2'>
                        <label className='fs-6 fw-bolder text-gray-900'>Email</label>
                        <input
                            placeholder='Email'
                    ...
                    <div className='mb-2'>
                        <label className='fs-6 fw-bolder text-gray-900'>Password</label>
                        <input
                    ...
                    <div className='mb-2'>
                        <label className='fs-6 fw-bolder text-gray-900'>Confirm Password</label>
                        <input
                    ...
                    <label className='fs-6 fw-bolder text-gray-900'>Date of Birth</label>
            ...
            {/* {!isEmptyArray(values) && values.map((item) =>
                <>
